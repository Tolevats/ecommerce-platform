    ...
    export default function ProductsPage() {
      ...
      // === Fetch Products ===
      // The query key now includes the selectedCategory.
      // React Query automatically refetches when this key changes.
      const { 
        data: products, 
        ...
        <div>
          ...
          <div className="text-center py-10">
            <p className="text-lg font-semibold text-gray-600 dark:text-gray-400">
              {isLoadingCategories ? `Loading categories...` : `Loading products...`}
            </p>
             {/* Grid of skeleton loaders */}
             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
               {Array.from({ length: selectedCategory ? 4 : 8 }).map((_, index) => ( // Show fewer skeletons when filtering
      ...
      {!isLoadingProducts && !isErrorProducts && (!products || products.length === 0) && (
          <div className="text-center py-10">
